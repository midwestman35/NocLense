    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown panel */}
          <div className="absolute top-full right-0 mt-1 w-48 bg-[var(--card-bg)] border border-[var(--border-color)] rounded-lg shadow-xl z-50 overflow-hidden">
            <button
              onClick={handleOpenAssistant}
              className="flex items-center gap-2 px-4 py-2 text-sm text-[var(--text-primary)] hover:bg-[var(--bg-light)] cursor-pointer w-full text-left transition-colors"
            >
