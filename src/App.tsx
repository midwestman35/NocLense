...
const MainLayout = () => {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setLoading(true);
    // Clear previous logs if new files are uploaded? Or append? 
    // Creating a fresh list for now as per likely intent of "opening" files.
    // If multi-file merge is desired in future, we'd append.
    setLogs([]);
