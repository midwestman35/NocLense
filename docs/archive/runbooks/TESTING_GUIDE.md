...
- To generate a different size, run: `node tools/scripts/generate-large-log.js [entries] [output-file]`
  - Example: `node tools/scripts/generate-large-log.js 100000 test-100k.log`
